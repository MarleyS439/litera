        ...
        <div class="area-jogo">
                            ...
                            <div class="areaDeFrutas">
                                <div class="cardsFrutas">
                                    <div class="card"  id="f1">
                                        <img src="./img/baloes 2/BalaoG.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p>G</p>
                                    </div>
                                    <div class="card" id="f2">
                                        <img src="./img/baloes 2/BalaoT.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="banana">T</p>
                                    </div>
                                    <div class="card" id="f3">
                                        <img src="./img/baloes 2/BalaoL.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="melancia">L</p>
                                    </div>
                                    <div class="card" id="f4">

                                        <img src="./img/baloes 2/BalaoP.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="morango">P</p>
                                    </div>
                                </div>
                                <div class="cardsFrutas2">
                                    <div class="card" id="f5">
                                        <img src="./img/baloes 2/BalaoF.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="pera">F</p>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" id="f6">
                                            <img src="./img/baloes 2/BalaoG.svg" alt="Maçã">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="maca">G</p>
                                        </div>
                                        <div class="swiper-slide" id="f7">
                                            <img src="./img/baloes 2/BalaoT.svg" alt="Banana">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="banana">T</p>
                                        </div>
                                        <div class="swiper-slide" id="f8">
                                            <img src="./img/baloes 2/BalaoL.svg" alt="Melancia">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="melancia">L</p>
                                        </div>
                                        <div class="swiper-slide" id="f9">
                                            <img src="./img/baloes 2/BalaoP.svg" alt="Morango">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="morango">P</p>
                                        </div>
                                        <div class="swiper-slide" id="f10">
                                            <img src="./img/baloes 2/BalaoF.svg" alt="Pera">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="pera">F</p>
                                        </div>
            ...
            <div class="area-itens">
                ...
                <div class="square square-blue" id="b1" onclick="moveToCenter(this)">
                    ...
                    <img src="./img/baloes 2/BalaoG.svg" alt="" class="balao" id="zoomBalao1">
                    
                    <div class="particulas"></div>
                </div>
                <div class="square square-red" id="b2" onclick="moveToCenterBottom(this)">
                    <img src="./img/baloes 2/BalaoT.svg" alt="" class="balao" id="zoomBalao2">
                    <div class="particulas"></div>
                </div>
                <div class="square square-red2" id="b3" onclick="moveToCenterBottom(this)">
                    <img src="./img/baloes 2/BalaoL.svg" alt="" class="balao" id="zoomBalao3">
                    <div class="particulas"></div>
                </div>
                <div class="square square-green" id="b4"onclick="moveToCenter(this)">
                    <img src="./img/baloes 2/BalaoP.svg" alt="" class="balao" id="zoomBalao4">
                    <div class="particulas"></div>
                </div>
                <div class="square square-green2" id="b5" onclick="moveToCenter(this)">
                    <img src="./img/baloes 2/BalaoF.svg" alt="" class="balao" id="zoomBalao5">
                    <div class="particulas"></div>
                </div>
