        ...
        <div class="area-jogo">
                            ...
                            <div class="areaDeFrutas">
                                <div class="cardsFrutas">
                                    <div class="card"  id="f1">
                                        <img src="./img/baloes 2/BalaoJ.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p>J</p>
                                    </div>
                                    <div class="card" id="f2">
                                        <img src="./img/baloes 2/BalaoR.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="banana">R</p>
                                    </div>
                                    <div class="card" id="f3">
                                        <img src="./img/baloes 2/BalaoM.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="melancia">M</p>
                                    </div>
                                    <div class="card" id="f4">

                                        <img src="./img/baloes 2/BalaoZ.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="morango">Z</p>
                                    </div>
                                </div>
                                <div class="cardsFrutas2">
                                    <div class="card" id="f5">
                                        <img src="./img/baloes 2/BalaoB.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="pera">B</p>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" id="f6">
                                            <img src="./img/baloes 2/BalaoJ.svg" alt="Maçã">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="maca">J</p>
                                        </div>
                                        <div class="swiper-slide" id="f7">
                                            <img src="./img/baloes 2/BalaoR.svg" alt="Banana">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="banana">R</p>
                                        </div>
                                        <div class="swiper-slide" id="f8">
                                            <img src="./img/baloes 2/BalaoM.svg" alt="Melancia">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="melancia">M</p>
                                        </div>
                                        <div class="swiper-slide" id="f9">
                                            <img src="./img/baloes 2/BalaoZ.svg" alt="Morango">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="morango">Z</p>
                                        </div>
                                        <div class="swiper-slide" id="f10">
                                            <img src="./img/baloes 2/BalaoB.svg" alt="Pera">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="pera">B</p>
                                        </div>
            ...
            <div class="area-itens">
                ...
                <div class="square square-blue" id="b1" onclick="moveToCenter(this)">
                    ...
                    <img src="./img/baloes 2/BalaoJ.svg" alt="" class="balao" id="zoomBalao1">
                    
                    <div class="particulas"></div>
                </div>
                <div class="square square-red" id="b2" onclick="moveToCenterBottom(this)">
                    <img src="./img/baloes 2/BalaoR.svg" alt="" class="balao" id="zoomBalao2">
                    <div class="particulas"></div>
                </div>
                <div class="square square-red2" id="b3" onclick="moveToCenterBottom(this)">
                    <img src="./img/baloes 2/BalaoM.svg" alt="" class="balao" id="zoomBalao3">
                    <div class="particulas"></div>
                </div>
                <div class="square square-green" id="b4"onclick="moveToCenter(this)">
                    <img src="./img/baloes 2/BalaoZ.svg" alt="" class="balao" id="zoomBalao4">
                    <div class="particulas"></div>
                </div>
                <div class="square square-green2" id="b5" onclick="moveToCenter(this)">
                    <img src="./img/baloes 2/BalaoB.svg" alt="" class="balao" id="zoomBalao5">
                    <div class="particulas"></div>
                </div>
