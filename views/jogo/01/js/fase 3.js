...
function fazerPergunta() {
  ...
  var perguntas = ['Audios/G.mp3','Audios/T.mp3','Audios/L.mp3',
  'Audios/P.mp3','Audios/F.mp3'];
...
balaoA.addEventListener("click", function() {
    balaoSelecionado = "G"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoE.addEventListener("click", function() {
    balaoSelecionado = "T"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoI.addEventListener("click", function() {
    balaoSelecionado = "L"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoO.addEventListener("click", function() {
    balaoSelecionado = "P"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoU.addEventListener("click", function() {
    balaoSelecionado = "F"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});
