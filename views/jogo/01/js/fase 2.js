...
function fazerPergunta() {
  ...
  var perguntas = ['Audios/J.mp3','Audios/R.mp3','Audios/M.mp3',
  'Audios/Z.mp3','Audios/B.mp3'];
...
balaoA.addEventListener("click", function() {
    balaoSelecionado = "J"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoE.addEventListener("click", function() {
    balaoSelecionado = "R"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoI.addEventListener("click", function() {
    balaoSelecionado = "M"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoO.addEventListener("click", function() {
    balaoSelecionado = "Z"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});

balaoU.addEventListener("click", function() {
    balaoSelecionado = "B"; // Armazena o balão selecionado
    clickLetra.src = "Falas jogo Balao/click.mp3"
    clickLetra.play();
});
