...
<body>
    <header>
        <nav class="nav-bar">
            ...
            <ul>
                <li class="navegacao"><a href=""><i class="fa-solid fa-house"></i></a></li>
                <li class="navegacao"><a href="" id="nav-jogos"><i class="fa-solid fa-store"></i></a></li>
            </ul>
            <div class="area-perfil">
                <a href="">
                    <div class="perfil">
                        <img src="img/sid.jpeg" alt="">
                    </div>
                    <p>Usúario</p>
                </a>
            </div>
    ...
    <section class="jogo-balao">
        ...
        <div class="area-jogo">
            <div class="fim" id="fim">
                ...
                <a href="../start.php" class="btn-fim-game">Home</a>
            </div>
            ...
            <div class="baloes">
                <div class="baloes">
                    <div class="box-balao">
                        <img src="img/baloes/A.png" alt="" class="balao1" onclick="selecaoBalao(b1)" id="b1">
                        <img src="img/baloes/E.png" alt="" class="balao2" onclick="selecaoBalao(b2)" id="b2">
                        <img src="img/baloes/I.png" alt="" class="balao3" onclick="selecaoBalao(b3)" id="b3">
                        <img src="img/baloes/O.png" alt="" class="balao4" onclick="selecaoBalao(b4)" id="b4">
                        <img src="img/baloes/U.png" alt="" class="balao5" onclick="selecaoBalao(b5)" id="b5">
                    </div>
                </div>
            </div>
