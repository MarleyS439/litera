    ...
    function responderPergunta(silaba) {
        ...
        // BANANA
            ...
            if (silabasSelecionadas.length === 3) {
                if (silabasSelecionadas[0] === 'silaba2' && silabasSelecionadas[1] === 'silaba1' && silabasSelecionadas[2] === 'silaba3' || silabasSelecionadas[0] === 'silaba2' && silabasSelecionadas[1] === 'silaba3' && silabasSelecionadas[2] === 'silaba1') {
                     //cor do botão por acertar novamente
                     btnVerific.style.borderColor = '#15BE26'
                     btnVerific.style.backgroundColor = '#9CFFA5'
                     aumentarMoedas()
                    ...
                    if (perguntaAtual < perguntas.length) {
                        setTimeout(function () {
                            ...
                            silaba3.src = imgSilaba
                            imgSilaba  = 'img/jogoFruta/silabas/CIA.svg'
                            silaba2.src = imgSilaba
        ...
        // MELANCIA
            ...
            if (silabasSelecionadas.length === 3) {
                if (silabasSelecionadas[0] === 'silaba3' && silabasSelecionadas[1] === 'silaba1' && silabasSelecionadas[2] === 'silaba2') {
        ...
        // MORANGO
            ...
            if (silabasSelecionadas.length === 3) {
                if (silabasSelecionadas[0] === 'silaba2' && silabasSelecionadas[1] === 'silaba1' && silabasSelecionadas[2] === 'silaba3') {
        ...
        // ABACAXI
            ...
            if (silabasSelecionadas.length === 4) {
                if (silabasSelecionadas[0] === 'silaba3' && silabasSelecionadas[1] === 'silaba1' && silabasSelecionadas[2] === 'silaba4' && silabasSelecionadas[3] === 'silaba2') {
        ...
        // LARANJA
            ...
            if (silabasSelecionadas.length === 3) {
                if (silabasSelecionadas[0] === 'silaba1' && silabasSelecionadas[1] === 'silaba3' && silabasSelecionadas[2] === 'silaba2') {
