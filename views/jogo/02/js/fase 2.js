...
let box5 = document.getElementById("bx5");
...
const silaba5 = document.getElementById("silaba5");
...
function fazerPergunta() {
  ...
  var perguntas = [
    "img/jogoFruta/figuras-frutas/caminhao.svg",
    "img/jogoFruta/figuras-frutas/foguete.svg",
    "img/jogoFruta/figuras-frutas/bicicleta.svg",
    "img/jogoFruta/figuras-frutas/navio.svg",
    "img/jogoFruta/figuras-frutas/onibus.svg",
    "img/jogoFruta/figuras-frutas/patinete.svg",
    "img/jogoFruta/figuras-frutas/moto.svg",
  ];

  var audioFruta = [
    "Falas Jogo Silabas/maça/caminhao.mp3",
    "Falas Jogo Silabas/banana/foguete.mp3",
    "Falas Jogo Silabas/melancia/bicicleta.mp3",
    "Falas Jogo Silabas/cereja/navio.mp3",
    "Falas Jogo Silabas/morango/onibus.mp3",
    "Falas Jogo Silabas/abacaxi/patinete.mp3",
    "Falas Jogo Silabas/pera/moto.mp3",
  ];
  ...
  comece.addEventListener("click", function () {
    ...
    setTimeout(function () {
      ...
      imgSilaba = "img/jogoFruta/silabas/MI.svg";
      silaba1.src = imgSilaba;

      imgSilaba = "img/jogoFruta/silabas/NHAO.svg";
      silaba5.src = imgSilaba;
  ...
  function responderPergunta(silaba) {
    ...
    if (perguntaAtual === 0 && audioAtual === 0) {
      ...
      if (areaSilabas[4]) {
        // Define a imagem e torna o campo de imagem visível
        sil5.src = areaSilabas[3];
        sil5.style.display = "block";
        retorne.style.display = "block";
      }
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              imgSilaba = "img/jogoFruta/silabas/TE.svg";
              silaba3.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/FO.svg";
              silaba2.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/GUE.svg";
              silaba1.src = imgSilaba;
          ...
          setTimeout(function () {
            ...
            box5.classList.add("moveRetorne");
            setTimeout(function () {
              ...
              box5.classList.remove("moveRetorne");
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              imgSilaba = "img/jogoFruta/silabas/TA.svg";
              silaba4.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/BI.svg";
              silaba3.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/CLE.svg";
              silaba2.src = imgSilaba;
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              silaba3.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/O.svg";
              silaba2.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/VI.svg";
              silaba1.src = imgSilaba;
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              imgSilaba = "img/jogoFruta/silabas/BUS.svg";
              silaba3.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/O2.svg";
              silaba2.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/NI.svg";
              silaba1.src = imgSilaba;
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              imgSilaba = "img/jogoFruta/silabas/PA.svg";
              silaba3.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/TE2.svg";
              silaba2.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/TI.svg";
              silaba1.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/NE.svg";
              silaba4.src = imgSilaba;
        ...
        if (
          ...
          if (perguntaAtual < perguntas.length) {
            setTimeout(function () {
              ...
              silaba2.src = imgSilaba;
              imgSilaba = "img/jogoFruta/silabas/TO.svg";
              silaba1.src = imgSilaba;
  ...
  silaba5.addEventListener("click", function () {
    responderPergunta(this);
  });
...
fruta1.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/maça/caminhao.mp3";
  audio.play();
  audio.volume = 1;
...
fruta2.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/banana/foguete.mp3";
  audio.play();
  audio.volume = 1;
...
fruta3.addEventListener('click', function() {
  ...
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/melancia/bicicleta.mp3";
  audio.play();
  audio.volume = 1;
...
fruta4.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/cereja/navio.mp3";
  audio.play();
  audio.volume = 1;
...
fruta5.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/morango/onibus.mp3";
  audio.play();
  audio.volume = 1;
...
fruta6.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/abacaxi/patinete.mp3";
  audio.play();
  audio.volume = 1;
...
fruta7.addEventListener('click', function() {
  limaparCard();
  // Exibe o modal
  audio.src = "Falas Jogo Silabas/pera/moto.mp3";
  audio.play();
  audio.volume = 1;
