                            ...
                            <div class="areaDeFrutas">
                                <div class="cardsFrutas">
                                    <div class="card" id="f1">
                                        <img src="./img/jogoFruta/figuras-frutas/caminhao.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p>Caminhão</p>
                                    </div>
                                    <div class="card" id="f2">
                                        <img src="./img/jogoFruta/figuras-frutas/foguete.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="banana">Foguete</p>
                                    </div>
                                    <div class="card" id="f3">
                                        <img src="./img/jogoFruta/figuras-frutas/bicicleta.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="melancia">Bicicleta</p>
                                    </div>
                                    <div class="card" id="f4">

                                        <img src="./img/jogoFruta/figuras-frutas/navio.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="morango">Navio</p>
                                    </div>
                                </div>
                                <div class="cardsFrutas2">
                                    <div class="card" id="f5">
                                        <img src="./img/jogoFruta/figuras-frutas/onibus.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="pera">Ônibus</p>
                                    </div>
                                    <div class="card" id="f6">
                                        <img src="./img/jogoFruta/figuras-frutas/patinete.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="cereja">Patinete</p>
                                    </div>
                                    <div class="card" id="f7">
                                        <img src="./img/jogoFruta/figuras-frutas/moto.svg" alt="">
                                        <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                        <p class="abacaxi">Moto</p>
                                    </div>
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" id="f9">
                                            <img src="./img/jogoFruta/figuras-frutas/caminhao.svg" alt="Maçã">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="maca">Caminhão</p>
                                        </div>
                                        <div class="swiper-slide" id="f10">
                                            <img src="./img/jogoFruta/figuras-frutas/foguete.svg" alt="Banana">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="banana">Foguete</p>
                                        </div>
                                        <div class="swiper-slide" id="f11">
                                            <img src="./img/jogoFruta/figuras-frutas/bicicleta.svg" alt="Melancia">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="melancia">Bicicleta</p>
                                        </div>
                                        <div class="swiper-slide" id="f12">
                                            <img src="./img/jogoFruta/figuras-frutas/navio.svg" alt="Morango">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="morango">Navio</p>
                                        </div>
                                        <div class="swiper-slide" id="f13">
                                            <img src="./img/jogoFruta/figuras-frutas/onibus.svg" alt="Pera">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="pera">Ônibus</p>
                                        </div>
                                        <div class="swiper-slide" id="f14">
                                            <img src="./img/jogoFruta/figuras-frutas/patinete.svg" alt="Cereja">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="cereja">Patinete</p>
                                        </div>
                                        <div class="swiper-slide" id="f15">
                                            <img src="./img/jogoFruta/figuras-frutas/moto.svg" alt="Abacaxi">
                                            <img class="somFruta" src="./img/jogoFruta/icoSom.svg" alt="">
                                            <p class="abacaxi">Moto</p>
                                        </div>
            ...
            <div class="area-itens">
                ...
                <div class="palavras">
                    <div class="boxPalavra">
                        ...
                        <img class="silBox" src="img/jogoFruta/silabas/MA.svg" alt="" id="sil5">
                        <div class="circulos">
                ...
                <div class="silabas">
                    ...
                    <div class="boxSilabas" id="bx5">
                        <img class="sil" src="" alt="" id="silaba5">
                    </div>
