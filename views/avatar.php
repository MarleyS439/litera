            ...
            <div class="conteinerOpcoes">
                <form action="../controller/insertAvatar.php" method="post" onchange="atualizarImagemBase()">
                    ...
                    foreach ($genero as $generos) : ?>
                        <div class="opcoes">
                            <!-- Adicione o atributo data-img com o valor de $generos['imgGenero'] -->
                            <input type="radio" name="genero" class="input-opcao" value="<?php echo $generos['codGenero'] ?>" data-img="<?php echo $generos["imgGenero"] ?>">
            ...
            <div class="conteinerOpcoes">
                <form action="../controller/insertAvatar.php" method="post" onchange="atualizarImagemCabelo()">
                    ...
                    foreach ($cabelo as $cabelos) : ?>
                        <div class="opcoes">
                            <!-- Adicione o atributo data-img com o valor de $cabelos['imgGenero'] -->
                            <input type="radio" name="cabelo" class="input-opcao" value="<?php echo $cabelos['codCabelo'] ?>" data-img="<?php echo $cabelos["imgCabelo"] ?>">
            ...
            <div class="conteinerOpcoes">
                ...
                <button type="submit">Proximo</button>
                    ...
                    foreach ($roupa as $roupas) : ?>
                        <div class="opcoes">
                            <!-- Adicione o atributo data-img com o valor de $cabelos['imgGenero'] -->
                            <input type="radio" name="roupa" class="input-opcao" value="<?php echo $roupas['codRoupa'] ?>" data-img="<?php echo $roupas["imgRoupa"] ?>">
