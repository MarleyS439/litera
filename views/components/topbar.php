<nav class="top-bar-litera">
    ...
    <div class="profile">
        <div class="profile-pic-user">
            ...
            <img src="../assets/images/icons/profile-circle.svg" alt="">
        </div>
    </div>
</nav>