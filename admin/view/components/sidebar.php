      ...
      <ul>
        ...
        <li>
          <a href="users.php" title="Reports" class="tooltip">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="icon icon-tabler icon-tabler-report-analytics" width="24"
              height="24" stroke-width="1" stroke="currentColor" fill="#fff" stroke-linecap="round"
              stroke-linejoin="round" aria-hidden="true">
