...
<div class="modal" id="modalBlockUser_<?php echo $usuario['codUsuario']; ?>">
    ...
    <div class="content-modal">
        ...
        <?php else : ?>
            ...
            <p id="notice">Este usuário poderá utilizar o Litera</p>
        <?php endif; ?>
    </div>
    ...
    <div class="actions-btn">
        <form action="../controller/processingUser.php" method="POST">
            ...
            <?php else : ?>
                ...
                <input type="hidden" id="userIdToDelete" name="userIdToDelete">
                <button type="submit" id="positive">Desbanir</button>
            <?php endif; ?>
            <button type="button" id="negative" onclick="closeModalBlockUser()">Não</button>
        </form>
    </div>
</div>