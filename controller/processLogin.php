...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($data !== null) {
        ...
        $erros = $data['erros']; // Corrigido para erros
        try {
            // Consulta dos dados do jogo do usuário
            $dadosJogo = DadosJogoUsuarioDao::selectById($id, $idFase);
            if ($dadosJogo) {
                ...
                echo "Dados do jogo do usuário não encontrados";
            }
