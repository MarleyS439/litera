...
try {
    ...
    $mail->SMTPSecure = 'tls'; // Usar 'ssl' se estiver usando SSL, ou 'tls' se estiver usando TLS
    $mail->Port       = 587; // Porta do servidor SMTP

    // Configuração do e-mail
    $mail->setFrom('seu-email@gmail.com', 'Litera');
    ...
    <body>
        ...
        <p>Só mais um passo para você se tornar parte da família Litera. Por favor, insira o código de verificação no site para finalizar a criação da sua conta.</p>
        <div class='container'>
            <div class='cards'><p>". $num_char[0] ."</p></div>
