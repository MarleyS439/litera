...
class PerfilDao{
    public static function insert($perfis){
        ...
        $query = "INSERT INTO tbperfil(codUsuario, nomePerfil, generoPerfil, iconPerfil, nivel, dataNasc, dataCriacao, dataModfc) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?)";        
        ...
        $stmt -> bindvalue(5, $perfis->getNivel());
        $stmt -> bindvalue(6, $perfis->getDataNasc());
        $stmt -> bindvalue(7, $perfis->getDataCriacao());
        $stmt -> bindvalue(8, $perfis->getDataModfc());
        $stmt ->execute();
    }
